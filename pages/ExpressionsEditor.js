...
const ExpressionsEditor = () => {
  ...
  return (
    <div className="expression__editor">
      ...
      <div className="expression__editor-content">
        <EditorContent editor={editor} />
      </div>
      <button className="btn primary upload" onClick={addImage}>
        Attach
      </button>
      <button className="btn primary save" onClick={saveExpression}>
        Express
      </button>
      ...
      <button
        ...
        onClick={() =>
          setMessageEvent("Your expression is queued for minting!")
        }
      >
        Mint
      </button>
      <button
        className="btn primary yield"
        onClick={() =>
          setMessageEvent("Your expression is pooled for yielding!")
        }
      >
        Yield
      </button>
...
const MenuBar = ({ editor }) => {
  ...
  return (
    <div className="menu">
      ...
      <button className={editor.isActive("paragraph") ? "btn hider" : "btn"}>
        <FontAwesomeIcon icon={faParagraph} />
      </button>
